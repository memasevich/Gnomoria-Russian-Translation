...
def process():
    ...
    # Достаем ТОЛЬКО чистые ключи (без мусора)
    # Ищем текст в кавычках перед двоеточием, состоящий только из ASCII
    ...
    with open('C:/Users/Lecoo/projects/GnomoriaTranslator/Gnomoria_PURE.json', 'w', encoding='utf-8') as f:
        json.dump(final_dict, f, ensure_ascii=False, indent=2)

    print(f"Reconstructed {len(final_dict)} keys.")
